...
All 2,566 IR labels pass (1,974 positives and 592 negatives). The checked
...
clean reject/reassigned near misses, plus imported OpenAI Agents JS guarded-tool governance bridge
edges.
