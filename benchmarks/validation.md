...
truth set to 1,712 passing labels without broadening provider identity inference or conflating
SDK-sandbox shell/filesystem/memory capability reachability with host-local execution risk.
