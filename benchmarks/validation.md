...
truth set to 1,768 passing labels without broadening provider identity inference or conflating
SDK-sandbox shell/filesystem/memory/skill-loading capability reachability, or exact/conditional SDK
sandbox runtime selection, including extension Runner backends, with host-local execution risk.
