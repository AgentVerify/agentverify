...
truth set to 1,819 passing labels without broadening provider identity inference or conflating
...
entry-source controls, Manifest workspace-root controls, and literal `sandbox.concurrencyLimits`
runtime controls, with host-local execution risk.
