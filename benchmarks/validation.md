...
truth set to 1,815 passing labels without broadening provider identity inference or conflating
...
entry-source controls, and literal `sandbox.concurrencyLimits` runtime controls, with host-local
execution risk.
