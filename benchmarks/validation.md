...
All 2,572 IR labels pass (1,980 positives and 592 negatives). The checked
...
edges, and same-file/imported helper predicate metadata for tool guardrail reject conditions.
