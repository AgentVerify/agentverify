...
unresolved. Schema v23 publishes the resulting fixed-binding split as five instance edges and five
...
manager attribute, a fallback manager, and a rebound imported constructor. Schema v23 distinguishes
...
Schema v23 therefore records five Python and one TypeScript boundary edges, all with unresolved root
...
Schema v23 additionally resolves 20 `Path.rename`/`Path.replace` moves: two renames and 18 replaces.
