...
truth set to 1,810 passing labels without broadening provider identity inference or conflating
...
`extraPathGrants` sandbox path-grant controls, Manifest environment-variable controls, and Manifest
entry-source controls, with host-local execution risk.
