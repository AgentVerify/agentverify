...
resolved 2,311 relationships, and completed in 283.3538 seconds on the development machine. Three parse
...
dependency count per repository; engine schema v92 carries both the 176-file total and the
21-repository coverage.

Engine benchmark schema v92 retains stable component-name taxonomies, category presence counts,
...
All 572 cross-rule labels pass.
...
unresolved. Six chained calls are inventoried. Dynamic calls with only browser-import context are
...
ordinary-object yields, and reassigned context targets. Registry, receiver, and evaluator fixtures
bring the rule to 38 positive and 54 negative exact labels.
...
`benchmarks/truthset.json` contains 572 exact labels across all 19 enabled rules: 289 positives and 283
...
package launchers. All 572 currently pass;
...
negatives. All 897 IR labels pass (657 positives and 240 negatives):
...
positives/three negatives, eight browser-evaluation positives/two negatives, 32 browser-receiver
positives/31 negatives, eight Python registry-tool
