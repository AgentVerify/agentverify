...
All 2,575 IR labels pass (1,983 positives and 592 negatives). The checked
...
edges, and same-file/imported/helper-result predicate metadata for tool guardrail reject
conditions.
