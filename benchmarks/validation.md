...
resolved 2,310 relationships, and completed in 281.561 seconds on the development machine. Three parse
...
dependency count per repository; engine schema v85 carries both the 176-file total and the
21-repository coverage.

Engine benchmark schema v85 retains stable component-name taxonomies, category presence counts,
...
Schema-v85 benchmark output measures native AI BOM endpoint resolution separately. AI BOM 1.2
...
All 516 cross-rule labels pass.
...
`benchmarks/truthset.json` contains 516 exact labels across all 19 enabled rules: 272 positives and 244
...
package launchers. All 516 currently pass;
...
negatives. All 835 IR labels pass (622 positives and 213 negatives):
