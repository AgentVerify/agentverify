...
All 2,569 IR labels pass (1,977 positives and 592 negatives). The checked
...
edges, and same-file helper predicate metadata for tool guardrail reject conditions.
