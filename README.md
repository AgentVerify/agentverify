...
agent-security review rules. Its curated cross-rule regression set contains 729 pinned positive and
negative labels, plus 2,007 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 2,007 separately scored component and relationship labels
