...
agent-security review rules. Its curated cross-rule regression set contains 340 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 288 separately scored relationship labels
