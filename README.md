...
agent-security review rules. Its curated cross-rule regression set contains 166 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 21 separately scored relationship labels
