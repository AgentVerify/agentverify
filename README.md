...
agent-security review rules. Its curated cross-rule regression set contains 262 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 139 separately scored relationship labels
