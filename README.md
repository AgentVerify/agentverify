...
negative labels, plus 732 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 732 separately scored component and relationship labels
