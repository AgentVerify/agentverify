...
agent-security review rules. Its curated cross-rule regression set contains 311 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 224 separately scored relationship labels
