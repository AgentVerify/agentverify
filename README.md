...
agent-security review rules. Its curated cross-rule regression set contains 320 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 233 separately scored relationship labels
