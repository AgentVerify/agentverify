...
agent-security review rules. Its curated cross-rule regression set contains 172 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 36 separately scored relationship labels
