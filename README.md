...
negative labels, plus 683 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 683 separately scored component and relationship labels
