...
agent-security review rules. Its curated cross-rule regression set contains 328 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 241 separately scored relationship labels
