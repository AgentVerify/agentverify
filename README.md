...
agent-security review rules. Its curated cross-rule regression set contains 299 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 212 separately scored relationship labels
