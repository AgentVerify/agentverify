...
agent-security review rules. Its curated cross-rule regression set contains 291 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 172 separately scored relationship labels
