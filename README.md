...
agent-security review rules. Its curated cross-rule regression set contains 242 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 123 separately scored relationship labels
