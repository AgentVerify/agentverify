...
agent-security review rules. Its curated cross-rule regression set contains 305 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 218 separately scored relationship labels
