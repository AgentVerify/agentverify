...
agent-security review rules. Its curated cross-rule regression set contains 659 pinned positive and
negative labels, plus 1,227 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 1,227 separately scored component and relationship labels
