...
agent-security review rules. Its curated cross-rule regression set contains 308 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 221 separately scored relationship labels
