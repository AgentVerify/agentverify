...
negative labels, plus 2,446 separately scored Agent IR component and relationship labels.
...
`agentverify benchmark verify-engine`, which checks the snapshot schema and aggregate totals.
...
bundled engine-results schema and checks that core summary totals match the packaged repository
entries.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 2,446 separately scored component and relationship labels
