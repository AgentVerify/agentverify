...
agent-security review rules. Its curated cross-rule regression set contains 432 pinned positive and
negative labels, plus 530 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 530 separately scored component and relationship labels
