...
negative labels, plus 1,803 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 1,803 separately scored component and relationship labels
