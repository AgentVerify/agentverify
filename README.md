...
agent-security review rules. Its curated cross-rule regression set contains 330 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 246 separately scored relationship labels
