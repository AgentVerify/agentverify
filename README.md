...
agent-security review rules. Its curated cross-rule regression set contains 345 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 348 separately scored relationship labels
