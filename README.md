...
negative labels, plus 740 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 740 separately scored component and relationship labels
