...
negative labels, plus 615 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 615 separately scored component and relationship labels
