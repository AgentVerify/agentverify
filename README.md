...
agent-security review rules. Its curated cross-rule regression set contains 298 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 189 separately scored relationship labels
