...
agent-security review rules. Its curated cross-rule regression set contains 284 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 165 separately scored relationship labels
