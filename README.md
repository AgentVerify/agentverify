...
agent-security review rules. Its curated cross-rule regression set contains 334 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 252 separately scored relationship labels
