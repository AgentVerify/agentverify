...
agent-security review rules. Its curated cross-rule regression set contains 467 pinned positive and
negative labels, plus 568 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 568 separately scored component and relationship labels
