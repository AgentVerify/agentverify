...
negative labels, plus 636 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 636 separately scored component and relationship labels
