...
agent-security review rules. Its curated cross-rule regression set contains 302 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 215 separately scored relationship labels
