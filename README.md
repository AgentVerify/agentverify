...
agent-security review rules. Its curated cross-rule regression set contains 268 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 149 separately scored relationship labels
