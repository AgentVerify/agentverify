...
agent-security review rules. Its curated cross-rule regression set contains 228 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 102 separately scored relationship labels
