...
negative labels, plus 987 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 987 separately scored component and relationship labels
