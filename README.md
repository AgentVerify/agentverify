...
negative labels, plus 452 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 452 separately scored component and relationship labels
