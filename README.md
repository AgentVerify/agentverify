...
negative labels, plus 652 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 652 separately scored component and relationship labels
