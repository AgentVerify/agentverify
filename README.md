...
agent-security review rules. Its curated cross-rule regression set contains 702 pinned positive and
negative labels, plus 1,373 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 1,373 separately scored component and relationship labels
