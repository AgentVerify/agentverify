...
negative labels, plus 802 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 802 separately scored component and relationship labels
