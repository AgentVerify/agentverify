...
negative labels, plus 2,478 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 2,478 separately scored component and relationship labels
