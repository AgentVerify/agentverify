...
agent-security review rules. Its curated cross-rule regression set contains 642 pinned positive and
negative labels, plus 1,200 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 1,200 separately scored component and relationship labels
