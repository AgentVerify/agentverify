...
negative labels, plus 2,387 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 2,387 separately scored component and relationship labels
