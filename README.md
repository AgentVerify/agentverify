...
agent-security review rules. Its curated cross-rule regression set contains 230 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 110 separately scored relationship labels
