...
agent-security review rules. Its curated cross-rule regression set contains 332 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 249 separately scored relationship labels
