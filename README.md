...
agent-security review rules. Its curated cross-rule regression set contains 349 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 371 separately scored relationship labels
