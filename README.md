...
agent-security review rules. Its curated cross-rule regression set contains 247 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 126 separately scored relationship labels
