...
agent-security review rules. Its curated cross-rule regression set contains 296 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 180 separately scored relationship labels
