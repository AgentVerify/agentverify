...
agent-security review rules. Its curated cross-rule regression set contains 236 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 117 separately scored relationship labels
