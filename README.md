...
agent-security review rules. Its curated cross-rule regression set contains 516 pinned positive and
negative labels, plus 787 separately scored Agent IR component and relationship labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 787 separately scored component and relationship labels
