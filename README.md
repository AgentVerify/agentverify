...
agent-security review rules. Its curated cross-rule regression set contains 336 pinned positive and
negative labels.
...
- [`benchmarks/ir-truthset.json`](benchmarks/ir-truthset.json) — 255 separately scored relationship labels
