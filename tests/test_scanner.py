...
def test_typescript_openai_web_search_tool_policy_is_exact() -> None:
    ...
    assert tools["webSearchTool@11"].attributes == {
        "constructor": "webSearchTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "web_search_filter_policy": "allowed-domains",
        "web_search_allowed_domains": ["kb.example.com", "support.example.com"],
        "web_search_allowed_domain_count": 2,
        "web_search_context_size": "medium",
        "web_search_options_binding": "importedSearchOptions",
        "web_search_options_resolution": "imported-local-const-object",
        "web_search_policy": "configured",
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["webSearchTool@12"].attributes == {
        "constructor": "webSearchTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "web_search_filter_policy": "allowed-domains",
        ...
        "web_search_allowed_domain_count": 2,
        "web_search_context_size": "medium",
        "web_search_options_binding": "reexportedSearchOptions",
        "web_search_options_resolution": "reexported-local-const-object",
        "web_search_policy": "configured",
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["webSearchTool@18"].attributes == {
        "constructor": "webSearchTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "execution_environment": "unresolved",
    ...
    assert tools["webSearchTool@9"].attributes == {
        "constructor": "webSearchTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "web_search_filter_policy": "allowed-domains",
        ...
        "web_search_allowed_domain_count": 2,
        "web_search_context_size": "medium",
        "web_search_options_binding": "starSearchOptions",
        "web_search_options_resolution": "imported-local-star-reexported-const-object",
        "web_search_policy": "configured",
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["webSearchTool@14"].attributes == {
        "constructor": "webSearchTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "execution_environment": "unresolved",
    ...
    assert {control.symbol_id for control in web_search_controls} == {
        ...
        "ts:imported-options.ts#control:webSearchTool@11.webSearchPolicy@11",
        "ts:imported-options.ts#control:webSearchTool@12.webSearchPolicy@12",
        "ts:location.ts#control:webSearchTool@8.webSearchPolicy@8",
        "ts:star-imported-options.ts#control:webSearchTool@9.webSearchPolicy@9",
    }
    domain_control = next(
        control
    ...
    imported_control = next(
        control
        for control in web_search_controls
        if control.symbol_id == "ts:imported-options.ts#control:webSearchTool@11.webSearchPolicy@11"
    )
    assert imported_control.attributes == {
        "analysis": "typescript-openai-agents-web-search-policy",
        "module": "@openai/agents",
        "constructor": "webSearchTool",
        "imported_symbol": "webSearchTool",
        "configuration": "webSearchTool",
        "search_scope": "web-search-tool",
        "source_tool": "webSearchTool@11",
        "source_tool_id": "ts:imported-options.ts#tool:webSearchTool@11",
        "scope": "production",
        "web_search_filter_policy": "allowed-domains",
        "web_search_allowed_domains": ["kb.example.com", "support.example.com"],
        "web_search_allowed_domain_count": 2,
    ...
    reexported_control = next(
        control
        for control in web_search_controls
        if control.symbol_id == "ts:imported-options.ts#control:webSearchTool@12.webSearchPolicy@12"
    )
    assert reexported_control.attributes == {
        "analysis": "typescript-openai-agents-web-search-policy",
        "module": "@openai/agents",
        "constructor": "webSearchTool",
        "imported_symbol": "webSearchTool",
        "configuration": "webSearchTool",
        "search_scope": "web-search-tool",
        "source_tool": "webSearchTool@12",
        "source_tool_id": "ts:imported-options.ts#tool:webSearchTool@12",
        "scope": "production",
        "web_search_filter_policy": "allowed-domains",
        "web_search_allowed_domains": ["kb.example.com", "support.example.com"],
        "web_search_allowed_domain_count": 2,
    ...
    star_control = next(
        control
        for control in web_search_controls
        if control.symbol_id
        == "ts:star-imported-options.ts#control:webSearchTool@9.webSearchPolicy@9"
    )
    assert star_control.attributes == {
        "analysis": "typescript-openai-agents-web-search-policy",
        "module": "@openai/agents",
        "constructor": "webSearchTool",
        "imported_symbol": "webSearchTool",
        "configuration": "webSearchTool",
        "search_scope": "web-search-tool",
        "source_tool": "webSearchTool@9",
        "source_tool_id": "ts:star-imported-options.ts#tool:webSearchTool@9",
        "scope": "production",
        "web_search_filter_policy": "allowed-domains",
        "web_search_allowed_domains": ["kb.example.com", "support.example.com"],
        "web_search_allowed_domain_count": 2,
    ...
    assert policy_edges == {
        ...
        (
            "tool",
            "webSearchTool@11",
            "ts:imported-options.ts#tool:webSearchTool@11",
            "configured-by",
            "control",
            "web-search-policy",
            "ts:imported-options.ts#control:webSearchTool@11.webSearchPolicy@11",
        ...
        (
            "tool",
            "webSearchTool@12",
            "ts:imported-options.ts#tool:webSearchTool@12",
            "configured-by",
            "control",
            "web-search-policy",
            "ts:imported-options.ts#control:webSearchTool@12.webSearchPolicy@12",
        ...
        (
            "tool",
            "webSearchTool@9",
            "ts:star-imported-options.ts#tool:webSearchTool@9",
            "configured-by",
            "control",
            "web-search-policy",
            "ts:star-imported-options.ts#control:webSearchTool@9.webSearchPolicy@9",
            "star-imported-options.ts",
            9,
        ),
        (
            "agent",
...
def test_typescript_openai_hosted_mcp_approval_policy_is_exact() -> None:
    ...
    assert tools["hostedMcpTool@37"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_approve_binding": "approved",
        "mcp_approval_handler_decision": "dynamic-callback-result",
        "mcp_approval_handler_approve_source": "conditional-call-result",
        "mcp_approval_handler_approve_call": "promptApproval",
        "mcp_approval_handler_fallback_decision": "reject",
        "mcp_approval_handler_review_resolution": (
            "same-file-helper-readline-question"
        ),
        "mcp_approval_handler_review_helper": "promptApproval",
    ...
    assert tools["hostedMcpTool@46"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
    ...
    assert tools["hostedMcpTool@54"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
    ...
    assert tools["hostedMcpTool@63"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_resolution": "inline-approval-object-return",
        "mcp_approval_handler_decision": "conditional-approve",
        "mcp_approval_handler_predicate": "request-field-prefix-literal",
        "mcp_approval_handler_predicate_field": "name",
        "mcp_approval_handler_predicate_values": ["read_"],
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["hostedMcpTool@71"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_resolution": "inline-approval-object-return",
        "mcp_approval_handler_decision": "conditional-approve",
        "mcp_approval_handler_predicate": "request-field-contains-literal",
        "mcp_approval_handler_predicate_field": "name",
        "mcp_approval_handler_predicate_values": ["_read_"],
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["hostedMcpTool@79"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_resolution": "inline-approval-object-return",
        "mcp_approval_handler_decision": "conditional-approve",
        "mcp_approval_handler_predicate": "request-field-in-literal-set",
        "mcp_approval_handler_predicate_field": "name",
        "mcp_approval_handler_predicate_values": ["read_page", "list_pages"],
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["hostedMcpTool@87"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_decision": "dynamic-callback-result",
        "mcp_approval_handler_approve_source": "call-result",
        "mcp_approval_handler_approve_call": "allowed.includes",
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["hostedMcpTool@96"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_resolution": "inline-approval-object-return",
        "mcp_approval_handler_decision": "conditional-approve",
        "mcp_approval_handler_predicate": "request-field-equals-literal",
        "mcp_approval_handler_predicate_field": "name",
        "mcp_approval_handler_predicate_values": ["read_page"],
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["hostedMcpTool@104"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_decision": "conditional-approve",
        "mcp_approval_handler_predicate": "request-field-not-equals-literal",
        "mcp_approval_handler_predicate_field": "data.riskScore",
        "mcp_approval_handler_predicate_values": [10],
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["hostedMcpTool@112"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_decision": "conditional-approve",
        "mcp_approval_handler_predicate": "request-field-equals-literal",
        "mcp_approval_handler_predicate_field": "data.readOnly",
        "mcp_approval_handler_predicate_values": [True],
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["hostedMcpTool@120"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
        ...
        "mcp_approval_handler_resolution": "inline-approval-object-return",
        "mcp_approval_handler_decision": "conditional-approve",
        "mcp_approval_handler_predicate": "request-field-not-in-literal-set",
        "mcp_approval_handler_predicate_field": "name",
        "mcp_approval_handler_predicate_values": ["delete_page", "erase_page"],
        "execution_environment": "unresolved",
        "scope": "production",
    }
    assert tools["hostedMcpTool@128"].attributes == {
        "constructor": "hostedMcpTool",
        "approval_policy": "not-applicable",
        "approval_handler": "not-applicable",
        "mcp_approval_policy": "always-required",
    ...
    assert capability_by_path_line[
        ("callback-agent.ts", 37)
    ].attributes["mcp_approval_handler_fallback_decision"] == "reject"
    assert capability_by_path_line[
        ("callback-agent.ts", 46)
    ].attributes["mcp_approval_handler_predicate"] == (
        "request-field-not-equals-literal"
    )
    assert (
        "mcp_approval_handler_predicate"
        not in capability_by_path_line[("callback-agent.ts", 54)].attributes
    )
    assert capability_by_path_line[
        ("callback-agent.ts", 63)
    ].attributes["mcp_approval_handler_predicate"] == (
        "request-field-prefix-literal"
    )
    assert capability_by_path_line[
        ("callback-agent.ts", 71)
    ].attributes["mcp_approval_handler_predicate"] == (
        "request-field-contains-literal"
    )
    assert capability_by_path_line[
        ("callback-agent.ts", 79)
    ].attributes["mcp_approval_handler_predicate"] == (
        "request-field-in-literal-set"
    )
    assert (
        "mcp_approval_handler_predicate"
        not in capability_by_path_line[("callback-agent.ts", 87)].attributes
    )
    assert capability_by_path_line[
        ("callback-agent.ts", 96)
    ].attributes["mcp_approval_handler_predicate"] == (
        "request-field-equals-literal"
    )
    assert capability_by_path_line[
        ("callback-agent.ts", 96)
    ].attributes["mcp_approval_handler_predicate_values"] == ["read_page"]
    assert capability_by_path_line[
        ("callback-agent.ts", 104)
    ].attributes["mcp_approval_handler_predicate"] == (
        "request-field-not-equals-literal"
    )
    assert capability_by_path_line[
        ("callback-agent.ts", 104)
    ].attributes["mcp_approval_handler_predicate_values"] == [10]
    assert capability_by_path_line[
        ("callback-agent.ts", 112)
    ].attributes["mcp_approval_handler_predicate"] == (
        "request-field-equals-literal"
    )
    assert capability_by_path_line[
        ("callback-agent.ts", 112)
    ].attributes["mcp_approval_handler_predicate_values"] == [True]
    assert capability_by_path_line[
        ("callback-agent.ts", 120)
    ].attributes["mcp_approval_handler_predicate"] == (
        "request-field-not-in-literal-set"
    )
    assert capability_by_path_line[
        ("callback-agent.ts", 120)
    ].attributes["mcp_approval_handler_predicate_values"] == [
        "delete_page",
        "erase_page",
    ]
    assert (
