...
- Continue OpenAI Agents Python safety-governance extraction where evidence remains exact: callbacks
  that distinguish explicit user/policy review from unconditional acknowledgement, ordered multi-star
  shadowing or package-level hosted/non-hosted MCP approval policy or `tool_config` exports,
