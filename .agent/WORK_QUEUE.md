...
- Prioritize real installation and scan feedback from the new GitHub issue forms. Reproduce reports
  and add regression cases before selecting the next bounded patch release; do not resume an
  unbounded feature-expansion loop merely because the research backlog remains large.
