...
- `framework_provider_taxonomy`: exact frontend-specific framework and provider imports, Gemini and
  ...
  literal models, official TypeScript AI SDK factories and dynamic imports, symbol-specific
...
- `python_agent_mcp_binding`: import-proven assigned Python MCP servers linked through direct literal
  ...
  forward, rebound, shadowed, near-package, and indirect-list negatives.
