...
framework, wrapper, or configuration path. Counts come from schema-v13
...
2,754 relationship endpoint observations, 1,875 carry IDs and 1,873 resolve to an observed component
...
edges resolve exactly. In Python files with repeated identities, schema v13 records 325 same-scope and
...
The native AI BOM 1.1 resolver independently classifies all 2,754 endpoints: 1,873 by symbol ID, 334
...
Schema v13 records 13 exact MCP-forwarding control edges: one explicit allowlist, two discovery
