...
framework, wrapper, or configuration path. Counts come from schema-v88
...
- Browser-page evaluation inventories 86 import-context calls and proves 36 receivers: two exact
  ...
  call is a known Playwright Locator derivation rooted in the imported page factory. Class or
  ...
  missed by the dotted-name gate are now inventoried; five remain unresolved. The other 50 fixed-script
...
The 538-label rule truth set and 863-label IR component/relationship set are curated regression
