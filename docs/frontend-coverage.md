...
framework, wrapper, or configuration path. Counts come from schema-v90
...
- Browser-page evaluation inventories 86 import-context calls and proves 41 receivers: two exact
  ...
  page and same-branch derived Locator under a fail-closed Playwright import guard. Class or
  ...
  missed by the dotted-name gate are now inventoried; five remain unresolved. The other 45 fixed-script
...
The 557-label rule truth set and 882-label IR component/relationship set are curated regression
