...
settings metadata. The pinned `routing.ts` example contributes the corpus
...
example contributes a three-turn delegated limit plus a delegated `gpt-5.4` model override with low
