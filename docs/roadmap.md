...
| 7 | Parameter-controlled network origins | 5 | 2 | 4 | 40 | Direct, same-file, imported-function, and registered-class tool origins in 7 pinned repositories across Python and TypeScript; fixed-host templates are common negatives |
...
- Detect tool parameters used as HTTP origins while preserving fixed-host URL templates as negatives.
