...
|---:|---|---:|---:|---:|---:|---|
| 1 | Agent bill of materials: models, providers, frameworks, tools, MCP | 4 | 5 | 5 | 100 | 44 multi-provider research signals; schema v65 proves exact selected-path framework/provider evidence in 40/48 repos, while schema v73 distinguishes exact Mistral/Groq/Cohere/Ollama calls from import-only presence; 50 have MCP signals and 69 have privileged-capability signals |
