...
| 7 | Parameter-controlled network origins | 5 | 2 | 4 | 40 | Direct and same-file-helper tool origins in 5 pinned repositories across Python and TypeScript; fixed-host templates are common negatives |
