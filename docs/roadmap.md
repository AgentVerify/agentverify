...
| 7 | Parameter-controlled network origins | 5 | 2 | 4 | 40 | Direct tool-parameter origins in 3 pinned repositories across Python and TypeScript; fixed-host templates are common negatives |
