...
|---:|---|---:|---:|---:|---:|---|
| 1 | Agent bill of materials: models, providers, frameworks, tools, MCP | 4 | 5 | 5 | 100 | 44 multi-provider research signals; schema v63 proves exact selected-path framework/provider evidence in 40/48 repos; 50 have MCP signals and 69 have privileged-capability signals |
...
| 6 | Sandbox boundary quality | 5 | 4 | 3 | 60 | 64 sandbox-positive; schema v63 finds 20 exact host/privilege/credential boundary reviews across 10 repos |
