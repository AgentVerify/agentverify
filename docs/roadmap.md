...
| 9 | Consequential-action audit coverage | 4 | 4 | 2 | 32 | 57 tracing-positive; exact ADK BigQuery resolution finds one available control and two test deployments, but zero production deployments |
