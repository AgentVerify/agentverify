...
|---:|---|---:|---:|---:|---:|---|
| 1 | Agent bill of materials: models, providers, frameworks, tools, MCP | 4 | 5 | 5 | 100 | 44 multi-provider research signals; schema v76 proves exact selected-path framework/provider evidence in 40/49 repos and distinguishes Python/TypeScript SDK calls plus symbol-specific framework wrappers from import-only presence; 50 have MCP signals and 69 have privileged-capability signals |
