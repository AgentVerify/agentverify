...
|---:|---|---:|---:|---:|---:|---|
| 1 | Agent bill of materials: models, providers, frameworks, tools, MCP | 4 | 5 | 5 | 100 | 44 multi-provider research signals; schema v77 proves exact selected-path framework/provider evidence in 40/49 repos, distinguishes symbol-specific provider wrappers from import-only presence, and adds exact direct Python Agent→MCP bindings; 50 have MCP signals and 69 have privileged-capability signals |
