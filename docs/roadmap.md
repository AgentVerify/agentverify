...
| 7 | Parameter-controlled network origins | 5 | 2 | 4 | 40 | Direct, same-file, and exact imported-helper tool origins in 7 pinned repositories across Python and TypeScript; fixed-host templates are common negatives |
