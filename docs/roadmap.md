...
| 5 | Filesystem scope and destructive writes | 5 | 4 | 3 | 60 | 59 writable-filesystem repos; 31 AV-FS001 reviews remain across 8 repositories after schema v113 proves Qwen-Agent's tool-controlled URL can influence only a hexadecimal SHA-256 cache segment beneath its configured root |
