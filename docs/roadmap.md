...
- Support OpenAI, Anthropic, Azure OpenAI, Google, AWS Bedrock, Mistral, Groq, Cohere, Ollama,
  ...
  MetaGPT, Marvin, AgentScope, OpenHands SDK, Trae Agent, Vercel AI SDK, and common MCP configuration shapes. Newer provider and
