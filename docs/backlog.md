...
The curated regression set has reached 373 pinned positive/negative locations, with 498 separately
scored IR component/relationship labels. Schema-v63 engine results and `docs/frontend-coverage.md` publish
