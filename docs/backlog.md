...
The curated regression set has reached 340 pinned positive/negative locations, with 264 separately
scored IR relationship labels. Schema-v47 engine results and `docs/frontend-coverage.md` publish
