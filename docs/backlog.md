...
execution-bound controls. AgentVerify emits distinct `trace-group`, `trace-id`,
`tracing-disabled`, `agent-turn-limit`, `agent-model-override`, and `trace-workflow` controls and
