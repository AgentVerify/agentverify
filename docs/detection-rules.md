...
| AV-FS001 | review | high | Agent tool writes to a dynamic filesystem path | 18 default-scope matches across 8 repositories |
| AV-NET001 | review | high | Agent tool sends an HTTP request to a parameter-controlled origin | 3 default-scope matches across 3 repositories |
