...
| AV-APPROVAL011 | review | high | Computer-use safety-check callback acknowledges every pending safety check | 1 exact OpenAI Agents JS example plus four local fixtures; singleton/no-handler and non-passthrough callbacks remain negative |
