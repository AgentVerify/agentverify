...
| AV-FS001 | review | high | Agent tool writes, copies, moves, or deletes a dynamic filesystem path without a proven narrow path-boundary control | 24 default-scope matches across 8 repositories |
