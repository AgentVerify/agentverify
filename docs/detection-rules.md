...
| AV-NET001 | review | high | Agent tool sends an HTTP request to a parameter-controlled origin | 13 default-scope matches across 7 repositories; schema v31 finds zero exact Python allowlists and one TypeScript configured-optional hostname policy whose empty default is open |
